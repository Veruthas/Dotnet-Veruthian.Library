...
{
    public class LookaheadOperationGenerator<TState, TReader, T> : MatchOperationGenerator<TState, TReader, T>, ILookaheadOperationGenerator<TState, TReader, T>
        where TState : Has<TReader>
        where TReader : ILookaheadReader<T>
        where T : IEquatable<T>
    {
        public LookaheadOperationGenerator(IOperationGenerator<TState> builder) : base(builder) { }
